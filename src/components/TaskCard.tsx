  ...
  const getPriorityStyle = (priority: string) => {
    switch (priority) {
      case 'P1': return { 
        ...
        label: 'Urgent',
        gradient: 'from-[hsl(0,70%,60%)] to-[hsl(350,70%,60%)]',
      ...
      case 'P2': return { 
        ...
        icon: <span className="emoji">⚡</span>,
        label: 'High',
        gradient: 'from-[hsl(30,70%,60%)] to-[hsl(40,70%,60%)]',
      ...
      case 'P3': return { 
        ...
        icon: <span className="emoji">🔹</span>,
        label: 'Medium',
        gradient: 'from-[hsl(var(--primary))] to-[hsl(calc(var(--primary) - 20deg))]',
      ...
      case 'P4': return { 
        ...
        icon: <span className="emoji">🍃</span>,
        label: 'Low',
        gradient: 'from-[hsl(150,70%,40%)] to-[hsl(160,70%,40%)]',
